...
import 'package:canteen_management_user/widgets/order_card.dart';
import 'package:canteen_management_user/widgets/progress_bar.dart';
import 'package:canteen_management_user/widgets/simple_app_bar.dart';
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              ...
              .collection("orders")
              .where("status", whereIn: ["placed", "confirmed"])//normal,placed
